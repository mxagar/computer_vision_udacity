...
- [Udacity Computer Vision Nanodegree: Introduction](#udacity-computer-vision-nanodegree-introduction)
  ...
  - [1. Image Representation \& Classification (Lesson 4)](#1-image-representation--classification-lesson-4)
    - [CV Pipeline](#cv-pipeline)
    - [Training a model](#training-a-model)
    - [Separating data: Basic classification idea](#separating-data-basic-classification-idea)
    - [Pixelmaps](#pixelmaps)
    - [**Notebook**: `1_1_Image_Representation` / `1. Images as Numerical Data.ipynb`](#notebook-1_1_image_representation--1-images-as-numerical-dataipynb)
    - [Color images](#color-images)
    - [**Notebook**: `1_1_Image_Representation` / `2. Visualizing RGB Channels.ipynb`](#notebook-1_1_image_representation--2-visualizing-rgb-channelsipynb)
    - [**Notebook**: `1_1_Image_Representation` / `3. Blue Screen.ipynb`](#notebook-1_1_image_representation--3-blue-screenipynb)
    - [Color Spaces and Transforms](#color-spaces-and-transforms)
    - [**Notebook**: `1_1_Image_Representation` / `5_1. HSV Color Space, Balloons.ipynb`](#notebook-1_1_image_representation--5_1-hsv-color-space-balloonsipynb)
    - [**Notebook**: Day \& Night Classifier: `1_1_Image_Representation` / `6_1. Visualizing the Data.ipynb`](#notebook-day--night-classifier-1_1_image_representation--6_1-visualizing-the-dataipynb)
    - [Labelled Data and Accuracy](#labelled-data-and-accuracy)
    - [Features](#features)
    - [Standardizing Output](#standardizing-output)
    - [**Notebook**: Day \& Night Classifier: `1_1_Image_Representation` / `6_2. Standardizing the Data.ipynb`](#notebook-day--night-classifier-1_1_image_representation--6_2-standardizing-the-dataipynb)
    - [**Notebook**: Day \& Night Classifier: `1_1_Image_Representation` / `6_3. Average Brightness.ipynb`](#notebook-day--night-classifier-1_1_image_representation--6_3-average-brightnessipynb)
    - [**Notebook**: Day \& Night Classifier: `1_1_Image_Representation` / `6_4. Classification.ipynb`](#notebook-day--night-classifier-1_1_image_representation--6_4-classificationipynb)
    - [Evaluation Metrics](#evaluation-metrics)
    - [**Notebook**: Day \& Night Classifier: `1_1_Image_Representation` / `6_5. Accuracy and Misclassification.ipynb`](#notebook-day--night-classifier-1_1_image_representation--6_5-accuracy-and-misclassificationipynb)
  - [2. Convolutional Filters and Edge Detection (Lesson 5)](#2-convolutional-filters-and-edge-detection-lesson-5)
    - [Filters](#filters)
    - [Frequency in Images](#frequency-in-images)
    - [Fourier Transform](#fourier-transform)
    - [**Notebook**: Fourier Transforms: `1_2_Convolutional_Filters_Edge_Detection` / `1. Fourier Transform.ipynb`](#notebook-fourier-transforms-1_2_convolutional_filters_edge_detection--1-fourier-transformipynb)
    - [High-Pass Filters \& Convolution](#high-pass-filters--convolution)
    - [Gradients and Sobel Filters](#gradients-and-sobel-filters)
    - [**Notebook**: Creating a Filter, Edge Detection: `1_2_Convolutional_Filters_Edge_Detection` / `2. Finding Edges and Custom Kernels.ipynb`](#notebook-creating-a-filter-edge-detection-1_2_convolutional_filters_edge_detection--2-finding-edges-and-custom-kernelsipynb)
    - [Lowpass Filters: Gausssian Blur](#lowpass-filters-gausssian-blur)
    - [**Notebook**: Gaussian Blur, Medical Images: `1_2_Convolutional_Filters_Edge_Detection` / `3. Gaussian Blur.ipynb`](#notebook-gaussian-blur-medical-images-1_2_convolutional_filters_edge_detection--3-gaussian-bluripynb)
    - [**Notebook**: High and Low Pass Filters: `1_2_Convolutional_Filters_Edge_Detection` / `4. Fourier Transform on Filters.ipynb`](#notebook-high-and-low-pass-filters-1_2_convolutional_filters_edge_detection--4-fourier-transform-on-filtersipynb)
    - [Convolutional Layer](#convolutional-layer)
    - [Canny Edge Detector](#canny-edge-detector)
    - [**Notebook**: Canny Edge Detection: `1_2_Convolutional_Filters_Edge_Detection` / `5. Canny Edge Detection.ipynb`](#notebook-canny-edge-detection-1_2_convolutional_filters_edge_detection--5-canny-edge-detectionipynb)
    - [Shape Detection](#shape-detection)
    - [Hough Transform for Line Detection](#hough-transform-for-line-detection)
    - [**Notebook**: `1_2_Convolutional_Filters_Edge_Detection` / `Hough lines.ipynb`, `Hough circles, agriculture.ipynb`](#notebook-1_2_convolutional_filters_edge_detection--hough-linesipynb-hough-circles-agricultureipynb)
    - [Object Detection](#object-detection)
    - [Object Recognition: Haar Cascades](#object-recognition-haar-cascades)
    - [**Notebook**: Face Detection Using OpenCV: `1_2_Convolutional_Filters_Edge_Detection` / `7. Haar Cascade, Face Detection.ipynb`](#notebook-face-detection-using-opencv-1_2_convolutional_filters_edge_detection--7-haar-cascade-face-detectionipynb)
    - [Bias](#bias)
    - [Features](#features-1)
  - [3. Types of Features and Image Segmentation (Lesson 6)](#3-types-of-features-and-image-segmentation-lesson-6)
    - [Types of Features](#types-of-features)
    - [Corner Detectors: Harris Corner detector](#corner-detectors-harris-corner-detector)
    - [**Notebook**: `1_3_Types_of_Features_Image_Segmentation` / `1. Harris Corner Detection.ipynb`](#notebook-1_3_types_of_features_image_segmentation--1-harris-corner-detectionipynb)
    - [Morphological operations: Dilation, Erosion, Opening, Closing](#morphological-operations-dilation-erosion-opening-closing)
    - [Contours](#contours)
    - [**Notebook**: `1_3_Types_of_Features_Image_Segmentation` / `2. Contour detection and features.ipynb`](#notebook-1_3_types_of_features_image_segmentation--2-contour-detection-and-featuresipynb)
    - [Contour Features](#contour-features)
    - [K-Means Segmentation](#k-means-segmentation)
    - [**Notebook**: `1_3_Types_of_Features_Image_Segmentation` / `3. K-means.ipynb`](#notebook-1_3_types_of_features_image_segmentation--3-k-meansipynb)
  - [4. Feature Vectors (Lesson 7)](#4-feature-vectors-lesson-7)
    ...
    - [Scale and rotation invariance](#scale-and-rotation-invariance)
    - [Forum Question: ORB](#forum-question-orb)
      - [Answer](#answer)
    - [**Notebook**: `1_4_Feature_Vectors` / `1. Image Pyramids.ipynb`](#notebook-1_4_feature_vectors--1-image-pyramidsipynb)
    - [Feature Matching](#feature-matching)
    - [ORB in video](#orb-in-video)
    - [**Notebook**: `1_4_Feature_Vectors` / `2. ORB.ipynb`](#notebook-1_4_feature_vectors--2-orbipynb)
    - [HOG = Histogram of Oriented Gradients](#hog--histogram-of-oriented-gradients)
    - [**Notebook**: `1_4_Feature_Vectors` / `3_1. HOG.ipynb`](#notebook-1_4_feature_vectors--3_1-hogipynb)
  - [5. CNN Layers and Feature Visualization (Lesson 8)](#5-cnn-layers-and-feature-visualization-lesson-8)
    - [Convolutional Layers](#convolutional-layers)
    - [Defining Layers in Pytorch](#defining-layers-in-pytorch)
    - [**Notebook**: `1_5_CNN_Layers` / `1. Conv Layer Visualization.ipynb`](#notebook-1_5_cnn_layers--1-conv-layer-visualizationipynb)
    - [Pooling layers](#pooling-layers)
    - [Fully Connected Layers](#fully-connected-layers)
    - [**Notebook**: `1_5_CNN_Layers` / `2. Pool Visualization.ipynb`](#notebook-1_5_cnn_layers--2-pool-visualizationipynb)
    - [**Notebook**: `1_5_CNN_Layers` / `3. Load and Visualize FashionMNIST.ipynb`](#notebook-1_5_cnn_layers--3-load-and-visualize-fashionmnistipynb)
    - [Training](#training)
    - [**Notebook**: `1_5_CNN_Layers` / `4_1. Classify FashionMNIST, exercise.ipynb`, `4_2. Classify FashionMNIST, solution 1.ipynb`, `4_3. Classify FashionMNIST, solution 2.ipynb`](#notebook-1_5_cnn_layers--4_1-classify-fashionmnist-exerciseipynb-4_2-classify-fashionmnist-solution-1ipynb-4_3-classify-fashionmnist-solution-2ipynb)
    - [Network structure: How to decide leayers, etc?](#network-structure-how-to-decide-leayers-etc)
    - [Feature Visualization](#feature-visualization)
    - [**Notebook**: `1_5_CNN_Layers` / `5_1. Feature viz for FashionMNIST`](#notebook-1_5_cnn_layers--5_1-feature-viz-for-fashionmnist)
    - [Last Feature Vector, Dimensionality Reduction](#last-feature-vector-dimensionality-reduction)
    - [Occlusion, Saliency, Guided Backpropagation](#occlusion-saliency-guided-backpropagation)
    - [Some Applications with Feature Maps](#some-applications-with-feature-maps)
    - [Popular Networks (my notes, not in Udacity)](#popular-networks-my-notes-not-in-udacity)
    ...
    - [Summary Examples (my notebooks, not in Udacity)](#summary-examples-my-notebooks-not-in-udacity)
  - [6. Project 1: Facial Keypoint Detection](#6-project-1-facial-keypoint-detection)
    - [Important Learnings](#important-learnings)
    - [Forum Question: Project 1: Face Keypoint Detection - Losses Not Decreasing](#forum-question-project-1-face-keypoint-detection---losses-not-decreasing)
      - [Question](#question)
      - [Answer](#answer-1)
      - [Follow Up](#follow-up)
